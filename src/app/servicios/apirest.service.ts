...
import {interconsulta, kine, datosmedicos, psicologia, nutricion} from '../datosapi/datosapi.models';
...
export class ApirestService {
  ...
  constructor(
    ...
    doEliminarfichamedica(datosmedicos:number) :Observable<any> {
      return this.http.delete<datosmedicos[]> ("http://35.193.42.58:3000/datosmedicos/" + datosmedicos)
    }
    ...
    doEditarficha(datosmedicos, id:string):Observable<any>{
      return this.http.patch<any>("http://35.193.42.58:3000/datosmedicos/"+id,datosmedicos)
    }

    doAgregarNutricion(nutricion: nutricion): Observable<nutricion[]>{
      return this.http.post<nutricion []>("http://35.193.42.58:3000/nutricions", nutricion)
    }

    doVernutricion(): Observable <nutricion[]> {
      return this.http.get<nutricion[]>("http://35.193.42.58:3000/nutricions")
    }
